...
import material.com.base.utils.ImageUtil;
...
public class SettingActivity extends BaseActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initToolbar();
        dataSave = new SaveUtil(this, "gank", BuildConfig.BUILD_TYPE.equals("debug") ? SaveUtil.DEBUG : SaveUtil.PUBLISH);
    ...
    private void addUnsetItem(FlowLayout layout, final String item){
        int ranHeight = ImageUtil.dip2px(this, 30);
        ViewGroup.MarginLayoutParams lp = new ViewGroup.MarginLayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ranHeight);
        lp.setMargins(ImageUtil.dip2px(this, 10), 0, ImageUtil.dip2px(this, 10), 0);
        TextView tv = new TextView(this);
        tv.setPadding(ImageUtil.dip2px(this, 15), 0, ImageUtil.dip2px(this, 15), 0);
