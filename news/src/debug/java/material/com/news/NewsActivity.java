...
public class NewsActivity extends BaseActivity{
    ...
    private void getDataFromSF(){
        try{
            SaveUtil share = new SaveUtil(getTargetContext("material.com.settings"), "gank",
                    BuildConfig.BUILD_TYPE.equals("debug") ? SaveUtil.DEBUG : SaveUtil.PUBLISH);
            SaveUtil dataSave = new SaveUtil(this, "gank",
                    BuildConfig.BUILD_TYPE.equals("debug") ? SaveUtil.DEBUG : SaveUtil.PUBLISH);
